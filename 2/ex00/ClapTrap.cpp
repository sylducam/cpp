...
ClapTrap::ClapTrap(void) : name("nameless"), _hitPoints(hitPointsDefault), energyPoints(energyPointsDefault), attackDamage(attackDamageDefault)
{
	std::cout << "Create ClapTrap '" << this->name << "'." << std::endl;
}

ClapTrap::ClapTrap(std::string name) : name(name), _hitPoints(hitPointsDefault), energyPoints(energyPointsDefault), attackDamage(attackDamageDefault)
{
	std::cout << "Create ClapTrap '" << this->name << "'." << std::endl;
}
...
void ClapTrap::takeDamage(unsigned int amount) 
{
	...
	else
	{
		...
		std::cout << "[HITTED] " << this->name << " loose " << amount << " hit points. He had now " << this->_hitPoints << " hit point." << std::endl;
	}
}
...
void ClapTrap::beRepaired(unsigned int amount) 
{
	...
	--this->energyPoints;
	this->_hitPoints += amount;
	std::cout << "[REPAIRED] " << this->name << " repair " << amount << " hit points. He had now " << this->_hitPoints << " hit point." << std::endl;
}
